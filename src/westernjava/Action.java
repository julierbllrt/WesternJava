...
public class Action {
                  ...
                  switch (chiffre) {
                        ...
                        case (1):
                              ...
                              if (random.nextInt(2) == 1) {
                                    ...
                                    cop.catchAThug(badlady, list_lieux);
            ...
            try {
                  ...
                  switch (chiffre) {
                        ...
                        case (2):
                              ...
                              if (random.nextInt(2) == 1) {
                                    Sherif cop = perso.randomSherif(list.get(1));
                                    cop.catchAThug(badcop, list_lieux);
                                    cop.freeTheLady(girl);
                              }
                              return badcop;
                                    ...
                                    case 0:
                                          ...
                                          switch (becoming) {
                                                case 1:
                                                      ...
                                                      list.get(1).get(0).remove(obj);
                                                      cop.shoot(badboy, cop, list_lieux);
                                                      return cop;

                                                default:
                                                      cop = (Sherif) perso.randomHumain(2, 3, list);
                                                      obj.shoot(badboy, cop, list_lieux);
                                                      return obj;
                                          }
                                    ...
                                    default:
                                          ...
                                          switch (becoming) {
                                                case 1:
                                                      Sherif cop = new Sherif(0, obj.popularity, obj.adjective, obj.money, obj.name, obj.favoriteDrink, obj.lieu);
                                                      list.get(1).get(0).remove(obj);
                                                      cop.shoot(badboy2, cop, list_lieux);
                                                      return cop;

                                                default:
                                                      cop = (Sherif) perso.randomHumain(2, 3, list);
                                                      obj.shoot(badboy2, cop, list_lieux);
                                                      return obj;
                                          }
                              }
                  ...
                  switch (chiffre) {
                        ...
                        case (2):
                              switch (random.nextInt(2)) {
                                    case 0:
                                          Thug badboy = (Thug) perso.randomHumain(2, 5, list);
                                          obj.shoot(badboy, obj, list_lieux);
                                          return obj;

                                    default:
                                          BadCop badboy2 = (BadCop) perso.randomHumain(2, 4, list);
                                          obj.shoot(badboy2, obj, list_lieux);
                                          return obj;
                              }
                  ...
                  switch (choice) {
                        ...
                        default:
                              if (obj.lieu instanceof MainStreet) {
                                    ...
                                    System.out.println("1 kidnapper une fille");
                                    System.out.println("2 parler à quelqu'un");
                                    System.out.println("3 commander un verre");
                                    input = scanner.nextLine();
                                    chiffre = Integer.parseInt(input);
                  ...
                  switch (choice) {
                        ...
                        default:
                              if (obj.lieu instanceof MainStreet) {
                                    ...
                                    System.out.println("2 commander un verre");
                                    input = scanner.nextLine();
                                    chiffre = Integer.parseInt(input);
      ...
      public Humain humain(int choice, Humain man, Lieux[] list_lieux,
            ...
            if (man instanceof ThugLady) {
                  ThugLady personnage = (ThugLady) man;
                  personnage = thuglady(choice, personnage, list_lieux, list);
                  return personnage;
            }
